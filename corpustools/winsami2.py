...
decoding_table = (
    ...
    "\u20AC"  # 0x80 -> EURO SIGN
    "\ufffe"  # 0x81 -> UNDEFINED
    "\u010C"  # 0x82 -> LATIN CAPITAL LETTER C WITH CARON
    "\u0192"  # 0x83 -> LATIN SMALL LETTER F WITH HOOK
    "\u010D"  # 0x84 -> LATIN SMALL LETTER C WITH CARON
    "\u01B7"  # 0x85 -> LATIN CAPITAL LETTER EZH
    "\u0292"  # 0x86 -> LATIN SMALL LETTER EZH
    "\u01EE"  # 0x87 -> LATIN CAPITAL LETTER EZH WITH CARON
    "\u01EF"  # 0x88 -> LATIN SMALL LETTER EZH WITH CARON
    "\u0110"  # 0x89 -> LATIN CAPITAL LETTER D WITH STROKE
    ...
    "\u2013"  # 0x96 -> EN DASH
    "\u2014"  # 0x97 -> EM DASH
    "\u0111"  # 0x98 -> LATIN SMALL LETTER D WITH STROKE
    "\u01E6"  # 0x99 -> LATIN CAPITAL LETTER G WITH CARON
    ...
    "\u00A0"  # 0xa0 -> NO-BREAK SPACE
    "\u01E7"  # 0xa1 -> LATIN SMALL LETTER G WITH CARON
    "\u01E4"  # 0xa2 -> LATIN CAPITAL LETTER G WITH STROKE
    "\u00A3"  # 0xa3 -> POUND SIGN
    "\u00A4"  # 0xa4 -> CURRENCY SIGN
    "\u01E5"  # 0xa5 -> LATIN SMALL LETTER G WITH STROKE
    "\u00A6"  # 0xa6 -> BROKEN BAR
    "\u00A7"  # 0xa7 -> SECTION SIGN
    "\u00A8"  # 0xa8 -> DIAERESIS
    "\u00A9"  # 0xa9 -> COPYRIGHT SIGN
    "\u021E"  # 0xaa -> LATIN CAPITAL LETTER H WITH CARON
    "\u00AB"  # 0xab -> LEFT-POINTING DOUBLE ANGLE QUOTATION MARK
    "\u00AC"  # 0xac -> NOT SIGN
    "\u00AD"  # 0xad -> SOFT HYPHEN
    "\u00AE"  # 0xae -> REGISTERED SIGN
    "\u021F"  # 0xaf -> LATIN SMALL LETTER H WITH CARON
    "\u00B0"  # 0xb0 -> DEGREE SIGN
    "\u00B1"  # 0xb1 -> PLUS-MINUS SIGN
    "\u01E8"  # 0xb2 -> LATIN CAPITAL LETTER K WITH CARON
    "\u01E9"  # 0xb3 -> LATIN SMALL LETTER K WITH CARON
    "\u00B4"  # 0xb4 -> ACUTE ACCENT
    "\u00B5"  # 0xb5 -> MICRO SIGN
    "\u00B6"  # 0xb6 -> PILCROW SIGN
    "\u00B7"  # 0xb7 -> MIDDLE DOT
    "\u014A"  # 0xb8 -> LATIN CAPITAL LETTER ENG
    "\u014B"  # 0xb9 -> LATIN SMALL LETTER ENG
    "\u0166"  # 0xba -> LATIN CAPITAL LETTER T WITH STROKE
    "\u00BB"  # 0xbb -> RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK
    "\u0167"  # 0xbc -> LATIN SMALL LETTER T WITH STROKE
    "\u00BD"  # 0xbd -> VULGAR FRACTION ONE HALF
    "\u017D"  # 0xbe -> LATIN CAPITAL LETTER Z WITH CARON
    "\u017E"  # 0xbf -> LATIN SMALL LETTER Z WITH CARON
