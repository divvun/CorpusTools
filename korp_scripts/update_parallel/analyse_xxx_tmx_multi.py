    ...
    if f.endswith('tmx'):
        try:
            ...
            for tuv in tuvs:
                ...
                cmd_hfst = '| hfst-tokenise --print-all --giella-cg --no-weights --unique ' + this_lang_dir + 'tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | vislcg3 --grammar  ' + this_lang_dir + 'tools/tokenisers/mwe-dis.bin | cg-mwesplit | vislcg3 --grammar  ' + this_lang_dir + 'src/cg3/disambiguator.bin | vislcg3 --grammar  ' + this_lang_dir + 'src/cg3/korp.bin | vislcg3 --grammar  ' + this_lang_dir + 'src/cg3/dependency.bin'
            ...
            tree.write(os.path.join(out_dir_path,str(f.split("/")[-1])),
